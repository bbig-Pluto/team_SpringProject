...
%>
    ...
    let updateMemoSbm = document.querySelector(".m_addBtn");
    updateMemoSbm.addEventListener("click", function(e){
    	console.log('update memo submit');
    	e.preventDefault();
    	blank();
    	
 	   		<% if(isLogon.equals("member")) { %>
 	   			<%System.out.println("업데이트 진입");%>
 	   				updateMemo.method = "get";
 	   				updateMemo.action = "/syl/updateMemo";
 	   				updateMemo.submit();
 	   				alert("저장!")
    		<% } else { %>
    				alert("로그인 후 이용해 주세요");
				...
				<div class="area_wrapper">
					<!--왼쪽영역-->
					 ...
					 <div class="calendarRight">
						...
						<form name="updateMemo">
							<div class="memo_container">
									<textarea type="text" name="m_content" class="content" >${m_content}</textarea>
