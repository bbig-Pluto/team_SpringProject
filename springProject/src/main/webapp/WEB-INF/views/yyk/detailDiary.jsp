...
.diary_slider {
	...
	background: /* 슬라이더 색상 */ linear-gradient( to right, #a0a8f8, #d9f196, #f8d996, #f08364);
...
.notes {
	...
	background-image: linear-gradient(to right, white 10px, transparent 10px),
		...
		repeating-linear-gradient(white, white 30px, #ffccaa 30px, #ffccaa,
		white 31px);
	line-height: 31px;
	/* padding: 8px 10px; */
	position: relative;
...
.diary_modify_btn {
	...
	border: none;
	border-radius: 15px;
	background-color: rgb(255, 198, 169);
	color: black;
	font-family: 'Nanum NeuRisNeuRisCe';
	font-size: 20px;
	font-weight: 500;
...
.diary_delete_btn {
	...
	background-color: rgb(254, 167, 124);
	color: white;
	font-family: 'Nanum NeuRisNeuRisCe';
	font-size: 20px;
	font-weight: 500;
...
/* 수정,삭제 버튼 hover */
.diary_delete_btn:hover, .diary_modify_btn:hover {
	background-color: #ffccaaad;
}
/* 목록버튼 hover */
.diary_goList_btn:hover {
	background-color: rgba(255, 224, 209, 0.722);
}
...
<script>
	window.onload = function() {
		...
		// 수정 버튼
		document.querySelector(".diary_modify_btn").addEventListener("click", function(e) {
			e.preventDefault();
