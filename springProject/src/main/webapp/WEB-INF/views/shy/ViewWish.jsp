	                    	...
	                    	<c:forEach var="wish" items="${wishlist }">
		                    	...
		                    	<a href="${contextPath }/pickWish?seqNum=${ wish.seqNum }">
			                        <div class="list">
			                            ...
			                            <input type="hidden" name="seqNum" value="${ wishlist.seqNum }">
			                        </div>
			                    </a>
...
<!-- 			                            <input name="photo" type="file" class="upload_photo" accept="image/*" required multiple> -->
			                        ...
			                        <div class="view_info">
			                            <input name="name" type="text" class="view_name" placeholder="상품 이름을 입력하세요" value="${wishlist.name }">
...
<!-- 			                            </select><br> -->
			                            ...
			                            <input name="price" type="text" class="price" value="${wishlist.price }"><br>
...
<%-- 			                            	<a href="${wishlist.link }">${wishlist.link }</a> --%>
						                ...
						                <a href="${contextPath }/wishlist/delWish.do?seqNum=${wishlist.seqNum}">
