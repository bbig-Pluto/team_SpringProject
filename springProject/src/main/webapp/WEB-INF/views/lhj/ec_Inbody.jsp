                ...
                <head>
                    ...
                    <style>
                        ...
                        .exercise_tr {
                            ...
                            font-size: 16px;
                            border-style: solid;
                            border-color: rgb(0, 0, 0) rgba(0, 128, 0, 0) rgb(0, 0, 0) rgba(0, 0, 0, 0);
                        }
                        ...
                        .body_calendar_caption {
                            ...
                            margin: 5px;
                            border-style: solid;
                            border-color: rgba(255, 255, 255, 0) rgba(0, 128, 0, 0) rgb(0, 0, 0) rgba(0, 0, 0, 0);
                        }
                                ...
                                insert_cancel
                                    .addEventListener(
                                        ...
                                        function (e) {
                                            ...
                                            // 추가버튼 생성
                                            let sapn_button_box = document.querySelector(".sapn_button_box");
                                            let html = sapn_button_box.innerHTML;
                                ...
                                let update_button = document.querySelector(".update_button");
                                    update_button.addEventListener("click",function (e) {
                                        ...
                                        update_button.remove();
                                            ...
                                            // 취소버튼 생성
                                            let sapn_button_box2 = document.querySelector(".sapn_button_box2");
                                    ...
                                    <div class="calendarWhole">
                                        ...
                                        <div class="tab_accordion_box">
                                            ...
                                            <div class="tab_accordion_box2">
                                                ...
                                                <form action="${path}/inbody/insert.do" method="post">
                                                    <table border="1">
                                                        <caption>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="hidden"
                                                                        ...
                                                                        class="sapn_text">${select_Inbody_Last[0].inBody_Height}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>체중</th>
                                                                <td><input type="hidden"
                                                                        ...
                                                                        class="sapn_text">${select_Inbody_Last[0].inBody_Weight}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>체지방량</th>
                                                                <td><input type="hidden"
                                                                        ...
                                                                        class="sapn_text">${select_Inbody_Last[0].inBody_Body_Fat}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>골격근량</th>
                                                                <td><input type="hidden"
                                                                        ...
                                                                        class="sapn_text">${select_Inbody_Last[0].inBody_Skeletal}</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <span class="sapn_button_box">
                                                        <input type="submit" value="확인">
                                                        <input type="button" value="추가" class="insert_button">
                                                        <input type="hidden" value="${select_Inbody_Last[0].seq_Inbody}" name="seq_Inbody">
                                                    </span>
                                                </form>
                                                ...
                                                <form action="${path}/inbody/update.do" method="post">
                                                    <table border="1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th>키</th>
                                                                <td><input type="hidden" value="${select_One_Inbody_2.inbody_Height_2}" class="update_hidden" name="inbody_Height_2">
                                                                    <span class="update_span">${select_One_Inbody_2.inbody_Height_2}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>체중</th>
                                                                <td><input type="hidden" value="${select_One_Inbody_2.inbody_Weight_2}"
                                                                        class="update_hidden" name="inbody_Weight_2"> <span
                                                                        class="update_span">${select_One_Inbody_2.inbody_Weight_2}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>체지방량</th>
                                                                <td><input type="hidden" value="${select_One_Inbody_2.inbody_Body_Fat_2}"
                                                                        class="update_hidden" name="inbody_Body_Fat_2"> <span
                                                                        class="update_span">${select_One_Inbody_2.inbody_Body_Fat_2}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>골격근량</th>
                                                                <td><input type="hidden" value="${select_One_Inbody_2.inbody_Skeletal_2}"
                                                                        class="update_hidden" name="inbody_Skeletal_2"> <span
                                                                        class="update_span">${select_One_Inbody_2.inbody_Skeletal_2}</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <span class="sapn_button_box2">
                                                        <input type="submit" value="확인">
                                                        <input type="button" value="수정" class="update_button">
                                                        <input type="hidden" value="${select_One_Inbody_2.seq_Inbody_2}" name="seq_Inbody_2">
                                                    </span>
                                                </form>
                                                <div class='scrolltable'
                                                    style="width:100%; height:100px; overflow:scroll; padding:10px; border:3; border-style:solid; border-color:#EBEBEB; overflow-x:hidden">
                                                    <form action="${path}/inbody/delete.do" method="post">
                                                        <table border="1">
                                                            <caption>
                                                                <div class="exercise_caption">나의 기록일지</div>
                                                            </caption>
                                                            <thead>
                                                                <tr>
                                                                    <th>날짜</th>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="select_Inbody_list"
                                                                    ...
                                                                    <tr>
                                                                        <td>${select_Inbody_list.inBody_Height}</td>
                                                                        <td>${select_Inbody_list.inBody_Weight}</td>
                                                                        <td>${select_Inbody_list.inBody_Weight}</td>
                                                                        <td>${select_Inbody_list.inBody_Body_Fat}</td>
                                                                        <td>${select_Inbody_list.inBody_Skeletal}</td>
                                                                    </tr>
                                                                </c:forEach>
                                                            </tbody>
                                                        </table>
